  ...
  logger: {
    ...
    */
    ...
    cloudwatch: {
      ...
      logGroupName: 'reports-dogtorsoftware',
      logStreamName: 'errors-dogtorsoftware-core',
      awsRegion: 'us-east-1',
      awsAccessKeyId: Env.get('AWS_ACCESS_KEY_LOGGER'),
      awsSecretKey: Env.get('AWS_SECRET_KEY_LOGGER'),
    },
  },
